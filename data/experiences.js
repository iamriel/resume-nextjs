const experiences = [
  {
    ...
    tasks: [
      ...
      'ILS -- Used NodeJS and Express for building RESTful api and React for building frontend side. Built a calendar and scheduling system which automatically sends notifications realtime with the help of websockets. Implement Organization management which contains members and different groups. Handle necessary security implementation both in the backend and frontend. Implement a trello like board with React that has tasks and users and with realtime updates.',
